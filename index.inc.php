...
<div id="address_bar">
	<form method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>">
		<input id="address_prefix" type="text" value="http://" disabled></input><input id="address_box" type="text" name="<?php echo $GLOBALS['_config']['url_var_name'] ?> value="duckduckgo.co.uk" onfocus="this.select()" /></label>
