...
<div id="address_bar">
	<form method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>">
		<input id="address_prefix" type="text" value="http://" disabled></input><input id="address_box" type="text" name="Address of Website" value="duckduckgo.co.uk" onfocus="this.select()" /></label>
